    ...
    <nav className="bg-stone-100 p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex space-x-6">
          <li>
            <a href="/" className="relative inline-block text-gray-900 text-base group">
          ...
          <li>
            <a href="/about" className="relative inline-block text-gray-900 text-base group">
              <span className="relative z-10">À propos</span>
              <span className="absolute left-0 bottom-0 h-0.5 w-0 bg-emerald-800 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </li>
          <li>
            <a href="/contact" className="relative inline-block text-gray-900 text-base group">
