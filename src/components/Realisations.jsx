    ...
    <section className="bg-white py-16 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 relative">
        ...
        <div className="w-full md:w-1/2 relative flex flex-wrap justify-center items-center gap-2">
          <img src="src/assets/images/photo18.jpeg" alt="Réalisation 1" className="w-16 h-16 object-cover rounded-md" />
          <img src="src/assets/images/photo3.png" alt="Réalisation 2" className="w-24 h-12 object-cover rounded-md" />
          <img src="src/assets/images/photo24.jpeg" alt="Réalisation 3" className="w-20 h-20 object-cover rounded-md" />
          <img src="src/assets/images/photo30.jpeg" alt="Réalisation 4" className="w-28 h-28 object-cover rounded-md" />
          <img src="src/assets/images/photo29.jpeg" alt="Réalisation 5" className="w-40 h-28 object-cover rounded-md" />
          <img src="src/assets/images/photo7.png" alt="Réalisation 6" className="w-36 h-36 object-cover rounded-md" />
          <img src="src/assets/images/photo2.jpeg" alt="Réalisation 7" className="w-48 h-40 object-cover rounded-md" />
        </div>
